/* SumaVectoresC.c
 ...
 Para compilar usar (-lrt: real time library, es posible que no sea necesario usar -lrt):
	gcc  -O2  SumaVectoresCSections.c -o SumaVectoresCSections -lrt
	gcc  -O2 -S SumaVectoresCSections.c -lrt
...
int main(int argc, char** argv){
  ...
  if (N<10) {
  printf("Tiempo:%20.9f\t / Tama�o Vectores:%u\n",tiempo,N);
  for(i=0; i<N; i++)
    printf("/ V1[%d]+V2[%d]=V3[%d](%8.6f+%8.6f=%8.6f) /\n",
           i,i,i,v1[i],v2[i],v3[i]);
  }
  else
    printf("Tiempo:%20.9f\t / Tama�o Vectores:%u\t/ V1[0]+V2[0]=V3[0](%8.6f+%8.6f=%8.6f)/ / V1[%d]+V2[%d]=V3[%d](%8.6f+%8.6f=%8.6f) /\n", tiempo,N,v1[0],v2[0],v3[0],N-1,N-1,N-1,v1[N-1],v2[N-1],v3[N-1]);
